...
export function assertValidNewPassword(password: string, confirmation?: string) { const value = String(password ?? ""); if (value.length < 4) throw new Error("password_too_short"); if (confirmation !== undefined && value !== confirmation) throw new Error("password_mismatch"); return value; }
