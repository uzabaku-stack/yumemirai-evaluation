...
export type EvaluationResultSnapshot = { id: number; evaluation_cycle_id: number | null; name: string; results: Record<string, unknown>; created_at: string; updated_at: string };
