...
export function BonusCalculator({ staff }: Props) {
  ...
  function exportCsv() {
    const header = ["計算モード", "スタッフ名", "職種", "基本給", "評価平均点", "評価係数", "休みマイナス率", "休み補正率", "基準賞与額", "最終賞与額", "メモ"];
